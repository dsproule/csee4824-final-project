...
module testbench_chunk;
    ...
    logic [63:0] mem2Icache_data, Icache2proc_data, Icache2mem_data;
    ...
    mem memory(
        ...
        .proc2mem_data(Icache2mem_data),                       // icache doesnt store any data
    ...
    initial begin
        ...
        Icache2mem_addr = `XLEN'd0;
        Icache2mem_data = 64'd100;
        Icache2mem_command = BUS_STORE;
        @(negedge clock);
        Icache2mem_addr = `XLEN'd4;
        Icache2mem_data = 64'd200;
        Icache2mem_command = BUS_STORE;
        @(negedge clock);
        Icache2mem_addr = `XLEN'd8;
        Icache2mem_data = 64'd300;
        Icache2mem_command = BUS_STORE;
        @(negedge clock);
