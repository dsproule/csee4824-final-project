...
extern "C" {
#endif
void  rmaPropagate0_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate0_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate0_wn_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate5_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate5_wn_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate6_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate6_wn_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate7_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate7_wn_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate9_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate9_wn_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate10_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate10_wn_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate11_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate11_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate11_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate11_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate11_wn_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate12_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate12_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate12_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate12_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate12_wn_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate13_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate13_wn_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate14_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate14_wn_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate15_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate15_wn_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate16_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate17_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate17_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate17_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate17_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate17_wn_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate18_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate18_wn_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate19_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate19_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate19_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate19_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate19_wn_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate20_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate20_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate20_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate20_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate20_t0_vis_simv_daidir (UB  * pcode, UB  val);
void  rmaPropagate20_wn_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate21_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate21_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate21_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate21_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate21_t0_vis_simv_daidir (UB  * pcode, UB  val);
void  rmaPropagate21_wn_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate22_p_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate22_vis_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate22_f_vis_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate22_r_vis_simv_daidir (UB  * pcode);
void  rmaPropagate22_wn_vis_simv_daidir (UB  * pcode, scalar  val);
